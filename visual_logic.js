 ...
 * Tue Apr 09 2024 18:14:41 GMT+0530 (India Standard Time)
...
addHTMLElement('button', 'button_1', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'red', 'button_1', false);
setHTMLElemStyle('height', '50px', 'button_1', false);
setHTMLElemStyle('width', '50px', 'button_1', false);
eventHTMLElem('click', 'button_1', false, function(event) {
  changeVis('Cube', true);
});
...
eventHTMLElem('click', 'button_1', false, function(event) {
  changeVis(cloneObject('Cube'), true);
  createPhysicsBody('DYNAMIC', cloneObject('Cube'), 'MESH', 10);
});
registerOnDrag('Cube', false, [0,1,2], function() {}, function() {
  dragMove('Cube', 'XYZ', 'vIfX^O%-5[}.Z2tY?[y4', 'uxF:`58bAS5yV*oQ2!x;');
}, function() {}, 'uxF:`58bAS5yV*oQ2!x;');

createPhysicsBody('STATIC', 'Plane', 'MESH', 0);
createPhysicsBody('STATIC', 'Plane.001', 'MESH', 0);
createPhysicsBody('STATIC', 'Plane.002', 'MESH', 0);

addHTMLElement('button', 'button_2', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'yellow', 'button_2', false);
setHTMLElemStyle('height', '50px', 'button_2', false);
setHTMLElemStyle('width', '50px', 'button_2', false);
eventHTMLElem('click', 'button_1', false, function(event) {
...
for (j = 1; j <= 10; j++) {
  ...
  if (k == 0) {
    for (i = 1; i <= 10; i += 2) {
      newpiece = cloneObject('Plane.001');
      setObjTransform(newpiece, false, 'position', [i * 4, j * 4, ''], false);
      floorlist.push(newpiece);
      newpiece = cloneObject('Plane');
      setObjTransform(newpiece, false, 'position', [(i + 1) * 4, j * 4, ''], false);
      floorlist.push(newpiece);
    }
  } else {
    for (i = 1; i <= 10; i += 2) {
...
createPhysicsBody('KINEMATIC', getObjectsFrom(floorlist, 'ALL'), 'MESH', 0);

eventHTMLElem('click', 'button_2', false, function(event) {
  changeVis(cloneObject('Cube.001'), true);
  createPhysicsBody('DYNAMIC', cloneObject('Cube.001'), 'MESH', 10);
});
registerOnDrag('Cube.001', false, [0,1,2], function() {}, function() {
  dragMove('Cube.001', 'XYZ', 'dR--@R{(f`S/bGC/]c|[', 'Vg?@@6DXm3a=)]=G$h5l');
}, function() {}, 'Vg?@@6DXm3a=)]=G$h5l');

addHTMLElement('button', 'button_3', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('backgroundColor', 'green', 'button_3', false);
setHTMLElemStyle('height', '50px', 'button_3', false);
setHTMLElemStyle('width', '50px', 'button_3', false);
eventHTMLElem('click', 'button_3', false, function(event) {
  changeVis('Cube.002', true);
});

eventHTMLElem('click', 'button_3', false, function(event) {
  changeVis(cloneObject('Cube.002'), true);
  createPhysicsBody('DYNAMIC', cloneObject('Cube.002'), 'MESH', 10);
});
registerOnDrag('Cube.002', false, [0,1,2], function() {}, function() {
  dragMove('Cube.002', 'XYZ', 'hj51(RsLOq1yrX-{0bq+', 'G=zZhVX0wIb|w`BcVATz');
}, function() {}, 'G=zZhVX0wIb|w`BcVATz');
